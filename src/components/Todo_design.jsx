...
const Todo_design = () => {
  return (
    <div class="max-w-xl mx-auto h-screen px-8 py-10 bg-white rounded-lg shadow-md dark:bg-gray-800">
      {/* title */}
      ...
      <div className="flex justify-between items-center mt-10">
       ...
       <input className="checkbox checkbox-info" type="checkbox" name="" id="todo"/>
        <label className="ml-2" for="todo"> I have a bike</label>
       </span>
       <span className="flex">
        <img className="w-5 h-5 cursor-pointer" src={editing} alt="" />
        <img className="w-5 h-5 ml-5 cursor-pointer" src={deleteimage} alt="" />
       </span>
      </div>
    </div>
  );
